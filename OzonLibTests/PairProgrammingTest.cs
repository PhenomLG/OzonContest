...
public class PairProgrammingTest
{
    ...
    public void Test1()
    {
        var result = PairProgramming.FormTeams(6, new[] { 2, 1, 3, 1, 1, 4 });
    ...
    public void Test2()
    {
        var result = PairProgramming.FormTeams(2, new[] { 5, 5 });
        Assert.Equal(result[0], new[] { 1, 2 });
    }
    ...
    public void Test3()
    {
        var result = PairProgramming.FormTeams(8, new[] { 1, 4, 2, 5, 4, 2, 6, 3 });
